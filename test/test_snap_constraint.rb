...
class TestSnapConstraint < Test::Unit::TestCase
  ...
  def test_initial_state()
    ...
    assert_nil           v1.snap(v2)              .force
    assert_equal 6,      v1.snap(v2, force: 6)    .force
  ...
  def test_force()
    ...
    c = v1.snap v2, motor: 90, force: 500
  ...
  def test_force_limits_the_motor()
    v1, v2, _, root = setup_views

    v1.snap v2, motor: 90, force: 0 # a powerless motor can not spin
